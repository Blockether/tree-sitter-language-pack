...
# alef:hash:6a1beba9af486663ac6a465c7a8f34d829b1fe8fe2f0850de58a7d4b10696352
...
defmodule E2e.RegistryTest do
  ...
  describe "registry_language_count" do
    @tag :skip
    test "language_count returns the number of languages available in the current build/cache" do
      # non-HTTP fixture: Elixir binding does not expose a callable for the configured `[e2e.call]` function
      :ok
    end
  end
