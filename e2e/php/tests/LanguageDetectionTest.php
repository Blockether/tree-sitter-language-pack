...
// alef:hash:5f542822f890f4a398e07e11e1e3e8c188a20749f7e025199467f8139622aa89
...
final class LanguageDetectionTest extends TestCase
{
    ...
    {
        $result = TreeSitterLanguagePack::detectLanguageFromContent(file_get_contents("#!/bin/bash\necho hi"));
    ...
    {
        $result = TreeSitterLanguagePack::detectLanguageFromContent(file_get_contents("#!/usr/bin/env python3\npass"));
