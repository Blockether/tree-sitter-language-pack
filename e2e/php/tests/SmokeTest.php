...
// alef:hash:b5691ac25700023f03013a003a9109a68de220d53ef409716cff9ad3aad75f51
...
final class SmokeTest extends TestCase
{
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "abl"]));
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "actionscript"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ada"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "agda"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "al"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "angular"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "apex"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "arduino"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "asciidoc"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "asm"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "astro"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "awk"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bash"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bass"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "batch"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "beancount"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bibtex"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bicep"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bitbake"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "blade"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "brightscript"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "bsl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "c"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "c3"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "caddy"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cairo"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "capnp"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cedar"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cedarschema"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cel"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cfml"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "chatito"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "chuck"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "circom"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "clarity"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "clojure"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cmake"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cobol"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "comment"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "commonlisp"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cooklang"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "corn"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cpon"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cpp"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("int main() { return 0; }", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "crystal"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "csharp"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "css"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cst"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "csv"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cuda"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cue"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "cylc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "d"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "dart"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("void main() {}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "desktop"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "devicetree"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "dhall"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "diff"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "djot"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "dockerfile"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "dot"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "doxygen"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "dtd"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "earthfile"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ebnf"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "editorconfig"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "eds"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "eex"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "elisp"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "elixir"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "elm"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "elsa"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "elvish"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "embeddedtemplate"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "enforce"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "erlang"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "facility"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "faust"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fennel"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fidl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "firrtl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fish"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("echo hello", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "foam"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "forth"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fortran"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fsharp"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "fsharp_signature"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "func"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gap"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gdscript"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gdshader"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "git_config"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "git_rebase"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gitattributes"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gitcommit"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gitignore"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gleam"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "glimmer"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "glsl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gn"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gnuplot"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "go"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "godot_resource"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gomod"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gosum"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gotmpl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gowork"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gpg"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "graphql"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gren"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("module Main exposing (..)", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "groovy"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("def x = 1", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "gstlaunch"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hack"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hare"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "haxe"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hcl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "heex"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hjson"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hlsl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hocon"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hoon"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "html"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "htmldjango"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "http"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hurl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "hyprlang"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "idris"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ini"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ispc"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "jai"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "janet"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "java"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("class Main {}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "javadoc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "jinja2"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "jq"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "jsdoc"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "json"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("{\"key\": \"value\"}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "json5"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "jsonnet"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("{ key: 'value' }", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "julia"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "just"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "kcl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "kconfig"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "kdl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "kotlin"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "latex"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "lean"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ledger"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "less"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "linkerscript"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "liquid"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "llvm"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "lua"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("print('hello')", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "luadoc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("---@param name string", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "luap"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "luau"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "magik"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "make"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "markdown"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "markdown_inline"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "matlab"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "mermaid"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "meson"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "mlir"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "mojo"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "move"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nasm"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "netlinx"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nginx"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nickel"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nim"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("echo \"hello\"", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ninja"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nix"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "norg"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "norg_meta"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nqc"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "nushell"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "objc"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ocaml"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ocaml_interface"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("val x : int", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ocamllex"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "odin"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("package main", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "openscad"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "org"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("* Hello\nWorld", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pascal"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pem"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "perl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("print 'hello';", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pgn"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "php"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "phpdoc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pkl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "po"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "poe_filter"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pony"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "postscript"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "powershell"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "printf"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "prisma"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "prolog"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "promql"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "properties"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("key=value", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "proto"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "prql"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "psv"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("a|b|c\n1|2|3", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pug"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "puppet"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "purescript"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("module Main where", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "pymanifest"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ql"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "qmldir"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "qmljs"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "query"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "r"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("print('hello')", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "racket"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rasi"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "razor"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rbs"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "re2c"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "readline"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "regex"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rego"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "requirements"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rescript"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("let x = 1", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "robot"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "roc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ron"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("(key: \"value\")", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rst"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("Hello\n=====\n\nWorld", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rtf"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ruby"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "rust"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("fn main() {}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "scala"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "scheme"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "scss"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "slang"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "smali"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "smalltalk"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "smithy"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sml"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "snakemake"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "solidity"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "souffle"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sourcepawn"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sparql"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sql"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sql_bigquery"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "squirrel"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ssh_config"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "stan"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "starlark"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "superhtml"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "svelte"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "sway"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "swift"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("print(\"hello\")", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "systemverilog"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tablegen"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tact"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tcl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("puts hello", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "teal"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "templ"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tera"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "terraform"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "test"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("===========\nTest\n===========\n---\n(node)", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "textproto"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("key: \"value\"", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "thrift"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tlaplus"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tmux"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "todotxt"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "toml"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("key = \"value\"", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tsv"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("a\tb\tc\n1\t2\t3", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "tsx"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "turtle"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "twig"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("{{ variable }}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "typescript"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "typespec"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "typoscript"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "typst"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("#let x = 1", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "udev"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ungrammar"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "uxntal"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "v"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("fn main() {}", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vb"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("Module Main\nEnd Module", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "verilog"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vhdl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vhs"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vim"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("echo 'hello'", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vimdoc"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vrl"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "vue"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wast"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wat"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("(module)", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wgsl"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wgsl_bevy"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wit"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "wolfram"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "x86asm"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "xcompose"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "xml"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "yaml"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("key: value", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "yuck"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "zig"]));
        $this->expectNotToPerformAssertions();
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ziggy"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "ziggy_schema"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("x", $config);
    }
    ...
    {
        $config = ProcessConfig::from_json(json_encode(["language" => "zsh"]));
        $this->expectNotToPerformAssertions();
        $result = TreeSitterLanguagePack::process("echo hello", $config);
    }
}
