...
// alef:hash:eb913d37d8e0fda8e4623e5681c85232bee1b016d64452c08cfc8ec9191db0a0
...
$extPath = __DIR__ . '/../../target/release/libtree_sitter_language_pack_php' . $extSuffix;
...
if (!extension_loaded('tree_sitter_language_pack_php') && file_exists($extPath)) {
