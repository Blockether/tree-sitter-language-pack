...
// alef:hash:fd187804f003377ee05eed4591dd88c454ed212f35cdbc5f06861133c64978d8
...
echo hi"#;
    ...
    assert_eq!(r.trim(), r#"bash"#, "equals assertion failed");
}
...
pass"#;
    let result = detect_language_from_content(content);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"python"#, "equals assertion failed");
}
...
fn test_detect_ext_cpp() {
    ...
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"cpp"#, "equals assertion failed");
}
...
fn test_detect_ext_go() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"go"#, "equals assertion failed");
}
...
fn test_detect_ext_java() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"java"#, "equals assertion failed");
}
...
fn test_detect_ext_javascript() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"javascript"#, "equals assertion failed");
}
...
fn test_detect_ext_php() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"php"#, "equals assertion failed");
}
...
fn test_detect_ext_ruby() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"ruby"#, "equals assertion failed");
}
...
fn test_detect_ext_rust() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"rust"#, "equals assertion failed");
}
...
fn test_detect_ext_typescript() {
    ...
    let result = detect_language_from_extension(ext);
    let r = result.as_ref().expect("Option<T> should be Some");
    assert_eq!(r.trim(), r#"typescript"#, "equals assertion failed");
}
