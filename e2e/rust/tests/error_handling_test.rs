...
// alef:hash:d3623780bb73fcd6c29666f65eeabdc36ba645dbee014faad16b495292e8a448
...
use tree_sitter_language_pack::{
    detect_language_from_content, detect_language_from_extension, detect_language_from_path, process,
};
...
fn test_error_empty_language_name() {
    ...
    let source = r#"hello"#;
    let config_json = serde_json::json!({"language": ""});
