...
# alef:hash:4eac63cf8a52e1dd84f6ecf199e10a7d16a559ca4845c3d75b14212a7cd5a3aa
...
async def test_python_chunking_medium() -> None:
...
async def test_python_chunking_process_detail() -> None:
...
async def test_rust_chunking_process() -> None:
...
async def test_rust_chunking_process_detail() -> None:
    """Intel: chunk multi-function Rust source into pieces."""
    source = "fn alpha() {}\n\nfn beta() {}\n\nfn gamma() {}\n\nfn delta() {}\n"
    config = {"chunk_max_size": 30, "language": "rust"}
