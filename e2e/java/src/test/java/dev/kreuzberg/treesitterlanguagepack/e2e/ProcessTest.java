...
// alef:hash:95a7c410d9710e2dc3bfb265ed8f4636c1ea5cd3fdf7c1b7aecdd6bcee532bb5
...
class ProcessTest {
    ...
    void testCFunctionProcess() throws Exception {
        ...
        assertTrue(result.structure().contains("Function"), "expected to contain: " + "Function");
    ...
    void testJavaClassProcess() throws Exception {
        ...
        assertTrue(result.structure().size() >= 1, "expected at least 1 elements");
        assertTrue(result.structure().contains("Class"), "expected to contain: " + "Class");
        assertTrue(result.imports().size() >= 1, "expected at least 1 elements");
        assertTrue(result.metrics().totalLines() >= 7, "expected >= 7");
        assertEquals(0, result.metrics().errorCount());
    }
    ...
    void testJavaPackageDeclarationProcess() throws Exception {
        ...
        assertTrue(result.structure().contains("Module"), "expected to contain: " + "Module");
        assertTrue(result.structure().contains("Class"), "expected to contain: " + "Class");
        assertEquals(0, result.metrics().errorCount());
    }
    ...
    void testProcessPythonImportsDetail() throws Exception {
        ...
        assertEquals("python", result.language().trim());
        assertTrue(result.imports().size() >= 2, "expected at least 2 elements");
        assertTrue(result.imports().contains("os"), "expected to contain: " + "os");
    }
    ...
    void testProcessRustStructureName() throws Exception {
        ...
        assertTrue(result.structure().size() >= 1, "expected at least 1 elements");
        assertTrue(result.structure().contains("MyConfig"), "expected to contain: " + "MyConfig");
    }
    ...
    void testPythonChunkingMedium() throws Exception {
        ...
        assertTrue(result.chunks().getFirst().content().size() <= 50, "expected <= 50");
    }
    ...
    void testPythonChunkingProcessDetail() throws Exception {
        ...
        assertTrue(result.chunks().size() >= 2, "expected at least 2 elements");
        assertTrue(result.chunks().getFirst().content().size() <= 30, "expected <= 30");
    }
