...
// alef:hash:9e98da80392041099863a11a9f5af283d98f2aa44ac6a2639d8cd2596036db7c
...
class SmokeTest {
    ...
    void testSmokeAbl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("abl").build();
    ...
    void testSmokeActionscript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("actionscript").build();
    ...
    void testSmokeAda() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ada").build();
    ...
    void testSmokeAgda() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("agda").build();
    ...
    void testSmokeAl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("al").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeAngular() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("angular").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeApex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("apex").build();
    ...
    void testSmokeArduino() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("arduino").build();
    ...
    void testSmokeAsciidoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("asciidoc").build();
    ...
    void testSmokeAsm() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("asm").build();
    ...
    void testSmokeAstro() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("astro").build();
    ...
    void testSmokeAwk() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("awk").build();
    ...
    void testSmokeBash() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bash").build();
    ...
    void testSmokeBass() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bass").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeBatch() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("batch").build();
    ...
    void testSmokeBeancount() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("beancount").build();
    ...
    void testSmokeBibtex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bibtex").build();
    ...
    void testSmokeBicep() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bicep").build();
    ...
    void testSmokeBitbake() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bitbake").build();
    ...
    void testSmokeBlade() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("blade").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeBrightscript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("brightscript").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeBsl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("bsl").build();
    ...
    void testSmokeC() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("c").build();
    ...
    void testSmokeC3() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("c3").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCaddy() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("caddy").build();
    ...
    void testSmokeCairo() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cairo").build();
    ...
    void testSmokeCapnp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("capnp").build();
    ...
    void testSmokeCedar() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cedar").build();
    ...
    void testSmokeCedarschema() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cedarschema").build();
    ...
    void testSmokeCel() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cel").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCfml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cfml").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeChatito() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("chatito").build();
    ...
    void testSmokeChuck() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("chuck").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCircom() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("circom").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeClarity() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("clarity").build();
    ...
    void testSmokeClojure() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("clojure").build();
    ...
    void testSmokeCmake() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cmake").build();
    ...
    void testSmokeCobol() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cobol").build();
    ...
    void testSmokeComment() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("comment").build();
    ...
    void testSmokeCommonlisp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("commonlisp").build();
    ...
    void testSmokeCooklang() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cooklang").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCorn() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("corn").build();
    ...
    void testSmokeCpon() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cpon").build();
    ...
    void testSmokeCpp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cpp").build();
        var result = TreeSitterLanguagePack.process("int main() { return 0; }", config);
    }
    ...
    void testSmokeCrystal() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("crystal").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCsharp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("csharp").build();
    ...
    void testSmokeCss() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("css").build();
    ...
    void testSmokeCst() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cst").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCsv() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("csv").build();
    ...
    void testSmokeCuda() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cuda").build();
    ...
    void testSmokeCue() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cue").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeCylc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("cylc").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeD() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("d").build();
    ...
    void testSmokeDart() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("dart").build();
        var result = TreeSitterLanguagePack.process("void main() {}", config);
    }
    ...
    void testSmokeDesktop() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("desktop").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeDevicetree() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("devicetree").build();
    ...
    void testSmokeDhall() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("dhall").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeDiff() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("diff").build();
    ...
    void testSmokeDjot() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("djot").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeDockerfile() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("dockerfile").build();
    ...
    void testSmokeDot() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("dot").build();
    ...
    void testSmokeDoxygen() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("doxygen").build();
    ...
    void testSmokeDtd() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("dtd").build();
    ...
    void testSmokeEarthfile() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("earthfile").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeEbnf() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ebnf").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeEditorconfig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("editorconfig").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeEds() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("eds").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeEex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("eex").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeElisp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("elisp").build();
    ...
    void testSmokeElixir() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("elixir").build();
    ...
    void testSmokeElm() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("elm").build();
    ...
    void testSmokeElsa() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("elsa").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeElvish() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("elvish").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeEmbeddedtemplate() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("embeddedtemplate").build();
    ...
    void testSmokeEnforce() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("enforce").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeErlang() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("erlang").build();
    ...
    void testSmokeFacility() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("facility").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeFaust() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("faust").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeFennel() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fennel").build();
    ...
    void testSmokeFidl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fidl").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeFirrtl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("firrtl").build();
    ...
    void testSmokeFish() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fish").build();
        var result = TreeSitterLanguagePack.process("echo hello", config);
    }
    ...
    void testSmokeFoam() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("foam").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeForth() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("forth").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeFortran() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fortran").build();
    ...
    void testSmokeFsharp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fsharp").build();
    ...
    void testSmokeFsharpSignature() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("fsharp_signature").build();
    ...
    void testSmokeFunc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("func").build();
    ...
    void testSmokeGap() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gap").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGdscript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gdscript").build();
    ...
    void testSmokeGdshader() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gdshader").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGitConfig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("git_config").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGitRebase() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("git_rebase").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGitattributes() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gitattributes").build();
    ...
    void testSmokeGitcommit() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gitcommit").build();
    ...
    void testSmokeGitignore() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gitignore").build();
    ...
    void testSmokeGleam() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gleam").build();
    ...
    void testSmokeGlimmer() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("glimmer").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGlsl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("glsl").build();
    ...
    void testSmokeGn() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gn").build();
    ...
    void testSmokeGnuplot() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gnuplot").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGodotResource() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("godot_resource").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGomod() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gomod").build();
    ...
    void testSmokeGosum() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gosum").build();
    ...
    void testSmokeGotmpl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gotmpl").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGowork() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gowork").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGpg() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gpg").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeGraphql() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("graphql").build();
    ...
    void testSmokeGren() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gren").build();
        var result = TreeSitterLanguagePack.process("module Main exposing (..)", config);
    }
    ...
    void testSmokeGroovy() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("groovy").build();
        var result = TreeSitterLanguagePack.process("def x = 1", config);
    }
    ...
    void testSmokeGstlaunch() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("gstlaunch").build();
    ...
    void testSmokeHack() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hack").build();
    ...
    void testSmokeHare() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hare").build();
    ...
    void testSmokeHaxe() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("haxe").build();
    ...
    void testSmokeHcl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hcl").build();
    ...
    void testSmokeHeex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("heex").build();
    ...
    void testSmokeHjson() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hjson").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHlsl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hlsl").build();
    ...
    void testSmokeHocon() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hocon").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHoon() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hoon").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHtmldjango() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("htmldjango").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHttp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("http").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHurl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hurl").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeHyprlang() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("hyprlang").build();
    ...
    void testSmokeIdris() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("idris").build();
    ...
    void testSmokeIni() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ini").build();
    ...
    void testSmokeIspc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ispc").build();
    ...
    void testSmokeJai() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("jai").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeJanet() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("janet").build();
    ...
    void testSmokeJava() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("java").build();
        var result = TreeSitterLanguagePack.process("class Main {}", config);
    }
    ...
    void testSmokeJavadoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("javadoc").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeJinja2() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("jinja2").build();
    ...
    void testSmokeJq() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("jq").build();
    ...
    void testSmokeJsdoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("jsdoc").build();
    ...
    void testSmokeJson() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("json").build();
        var result = TreeSitterLanguagePack.process("{\"key\": \"value\"}", config);
    }
    ...
    void testSmokeJson5() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("json5").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeJsonnet() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("jsonnet").build();
        var result = TreeSitterLanguagePack.process("{ key: 'value' }", config);
    }
    ...
    void testSmokeJulia() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("julia").build();
    ...
    void testSmokeJust() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("just").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeKcl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("kcl").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeKconfig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("kconfig").build();
    ...
    void testSmokeKdl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("kdl").build();
    ...
    void testSmokeKotlin() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("kotlin").build();
    ...
    void testSmokeLatex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("latex").build();
    ...
    void testSmokeLean() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("lean").build();
    ...
    void testSmokeLedger() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ledger").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeLess() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("less").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeLinkerscript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("linkerscript").build();
    ...
    void testSmokeLiquid() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("liquid").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeLlvm() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("llvm").build();
    ...
    void testSmokeLua() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("lua").build();
        var result = TreeSitterLanguagePack.process("print('hello')", config);
    }
    ...
    void testSmokeLuadoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("luadoc").build();
        var result = TreeSitterLanguagePack.process("---@param name string", config);
    }
    ...
    void testSmokeLuap() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("luap").build();
    ...
    void testSmokeLuau() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("luau").build();
    ...
    void testSmokeMagik() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("magik").build();
    ...
    void testSmokeMake() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("make").build();
    ...
    void testSmokeMarkdown() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("markdown").build();
    ...
    void testSmokeMarkdownInline() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("markdown_inline").build();
    ...
    void testSmokeMatlab() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("matlab").build();
    ...
    void testSmokeMermaid() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("mermaid").build();
    ...
    void testSmokeMeson() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("meson").build();
    ...
    void testSmokeMlir() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("mlir").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeMojo() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("mojo").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeMove() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("move").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNasm() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nasm").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNetlinx() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("netlinx").build();
    ...
    void testSmokeNginx() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nginx").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNickel() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nickel").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNim() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nim").build();
        var result = TreeSitterLanguagePack.process("echo \"hello\"", config);
    }
    ...
    void testSmokeNinja() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ninja").build();
    ...
    void testSmokeNix() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nix").build();
    ...
    void testSmokeNorg() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("norg").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNorgMeta() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("norg_meta").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeNqc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nqc").build();
    ...
    void testSmokeNushell() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("nushell").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeObjc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("objc").build();
    ...
    void testSmokeOcaml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ocaml").build();
    ...
    void testSmokeOcamlInterface() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ocaml_interface").build();
        var result = TreeSitterLanguagePack.process("val x : int", config);
    }
    ...
    void testSmokeOcamllex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ocamllex").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeOdin() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("odin").build();
        var result = TreeSitterLanguagePack.process("package main", config);
    }
    ...
    void testSmokeOpenscad() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("openscad").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeOrg() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("org").build();
        var result = TreeSitterLanguagePack.process("* Hello\nWorld", config);
    }
    ...
    void testSmokePascal() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pascal").build();
    ...
    void testSmokePem() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pem").build();
    ...
    void testSmokePerl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("perl").build();
        var result = TreeSitterLanguagePack.process("print 'hello';", config);
    }
    ...
    void testSmokePgn() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pgn").build();
    ...
    void testSmokePhp() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("php").build();
    ...
    void testSmokePhpdoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("phpdoc").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokePkl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pkl").build();
    ...
    void testSmokePo() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("po").build();
    ...
    void testSmokePoeFilter() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("poe_filter").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokePony() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pony").build();
    ...
    void testSmokePostscript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("postscript").build();
    ...
    void testSmokePowershell() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("powershell").build();
    ...
    void testSmokePrintf() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("printf").build();
    ...
    void testSmokePrisma() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("prisma").build();
    ...
    void testSmokeProlog() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("prolog").build();
    ...
    void testSmokePromql() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("promql").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeProperties() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("properties").build();
        var result = TreeSitterLanguagePack.process("key=value", config);
    }
    ...
    void testSmokeProto() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("proto").build();
    ...
    void testSmokePrql() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("prql").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokePsv() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("psv").build();
        var result = TreeSitterLanguagePack.process("a|b|c\n1|2|3", config);
    }
    ...
    void testSmokePug() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pug").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokePuppet() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("puppet").build();
    ...
    void testSmokePurescript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("purescript").build();
        var result = TreeSitterLanguagePack.process("module Main where", config);
    }
    ...
    void testSmokePymanifest() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("pymanifest").build();
    ...
    void testSmokeQl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ql").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeQmldir() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("qmldir").build();
    ...
    void testSmokeQmljs() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("qmljs").build();
    ...
    void testSmokeQuery() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("query").build();
    ...
    void testSmokeR() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("r").build();
        var result = TreeSitterLanguagePack.process("print('hello')", config);
    }
    ...
    void testSmokeRacket() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("racket").build();
    ...
    void testSmokeRasi() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rasi").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRazor() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("razor").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRbs() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rbs").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRe2c() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("re2c").build();
    ...
    void testSmokeReadline() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("readline").build();
    ...
    void testSmokeRegex() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("regex").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRego() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rego").build();
    ...
    void testSmokeRequirements() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("requirements").build();
    ...
    void testSmokeRescript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rescript").build();
        var result = TreeSitterLanguagePack.process("let x = 1", config);
    }
    ...
    void testSmokeRobot() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("robot").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("roc").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeRon() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ron").build();
        var result = TreeSitterLanguagePack.process("(key: \"value\")", config);
    }
    ...
    void testSmokeRst() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rst").build();
        var result = TreeSitterLanguagePack.process("Hello\n=====\n\nWorld", config);
    }
    ...
    void testSmokeRtf() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("rtf").build();
    ...
    void testSmokeRuby() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ruby").build();
    ...
    void testSmokeScala() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("scala").build();
    ...
    void testSmokeScheme() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("scheme").build();
    ...
    void testSmokeScss() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("scss").build();
    ...
    void testSmokeSlang() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("slang").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSmali() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("smali").build();
    ...
    void testSmokeSmalltalk() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("smalltalk").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSmithy() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("smithy").build();
    ...
    void testSmokeSml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sml").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSnakemake() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("snakemake").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSolidity() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("solidity").build();
    ...
    void testSmokeSouffle() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("souffle").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSourcepawn() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sourcepawn").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSparql() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sparql").build();
    ...
    void testSmokeSql() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sql").build();
    ...
    void testSmokeSqlBigquery() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sql_bigquery").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSquirrel() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("squirrel").build();
    ...
    void testSmokeSshConfig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ssh_config").build();
    ...
    void testSmokeStan() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("stan").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeStarlark() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("starlark").build();
    ...
    void testSmokeSuperhtml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("superhtml").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSvelte() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("svelte").build();
    ...
    void testSmokeSway() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("sway").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeSwift() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("swift").build();
        var result = TreeSitterLanguagePack.process("print(\"hello\")", config);
    }
    ...
    void testSmokeSystemverilog() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("systemverilog").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTablegen() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tablegen").build();
    ...
    void testSmokeTact() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tact").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTcl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tcl").build();
        var result = TreeSitterLanguagePack.process("puts hello", config);
    }
    ...
    void testSmokeTeal() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("teal").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTempl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("templ").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTera() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tera").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTerraform() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("terraform").build();
    ...
    void testSmokeTest() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("test").build();
        var result = TreeSitterLanguagePack.process("===========\nTest\n===========\n---\n(node)", config);
    }
    ...
    void testSmokeTextproto() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("textproto").build();
        var result = TreeSitterLanguagePack.process("key: \"value\"", config);
    }
    ...
    void testSmokeThrift() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("thrift").build();
    ...
    void testSmokeTlaplus() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tlaplus").build();
    ...
    void testSmokeTmux() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tmux").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTodotxt() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("todotxt").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeToml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("toml").build();
        var result = TreeSitterLanguagePack.process("key = \"value\"", config);
    }
    ...
    void testSmokeTsv() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tsv").build();
        var result = TreeSitterLanguagePack.process("a\tb\tc\n1\t2\t3", config);
    }
    ...
    void testSmokeTsx() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("tsx").build();
    ...
    void testSmokeTurtle() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("turtle").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTwig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("twig").build();
        var result = TreeSitterLanguagePack.process("{{ variable }}", config);
    }
    ...
    void testSmokeTypescript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("typescript").build();
    ...
    void testSmokeTypespec() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("typespec").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTyposcript() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("typoscript").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeTypst() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("typst").build();
        var result = TreeSitterLanguagePack.process("#let x = 1", config);
    }
    ...
    void testSmokeUdev() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("udev").build();
    ...
    void testSmokeUngrammar() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ungrammar").build();
    ...
    void testSmokeUxntal() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("uxntal").build();
    ...
    void testSmokeV() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("v").build();
        var result = TreeSitterLanguagePack.process("fn main() {}", config);
    }
    ...
    void testSmokeVb() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vb").build();
        var result = TreeSitterLanguagePack.process("Module Main\nEnd Module", config);
    }
    ...
    void testSmokeVerilog() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("verilog").build();
    ...
    void testSmokeVhdl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vhdl").build();
    ...
    void testSmokeVhs() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vhs").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeVim() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vim").build();
        var result = TreeSitterLanguagePack.process("echo 'hello'", config);
    }
    ...
    void testSmokeVimdoc() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vimdoc").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeVrl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vrl").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeVue() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("vue").build();
    ...
    void testSmokeWast() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wast").build();
    ...
    void testSmokeWat() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wat").build();
        var result = TreeSitterLanguagePack.process("(module)", config);
    }
    ...
    void testSmokeWgsl() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wgsl").build();
    ...
    void testSmokeWgslBevy() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wgsl_bevy").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeWit() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wit").build();
    ...
    void testSmokeWolfram() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("wolfram").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeX86asm() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("x86asm").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeXcompose() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("xcompose").build();
    ...
    void testSmokeXml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("xml").build();
    ...
    void testSmokeYaml() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("yaml").build();
        var result = TreeSitterLanguagePack.process("key: value", config);
    }
    ...
    void testSmokeYuck() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("yuck").build();
    ...
    void testSmokeZig() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("zig").build();
    ...
    void testSmokeZiggy() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ziggy").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeZiggySchema() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("ziggy_schema").build();
        var result = TreeSitterLanguagePack.process("x", config);
    }
    ...
    void testSmokeZsh() throws Exception {
        ...
        var config = ProcessConfig.builder().withLanguage("zsh").build();
        var result = TreeSitterLanguagePack.process("echo hello", config);
    }
