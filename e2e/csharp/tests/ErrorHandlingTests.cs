...
// alef:hash:d8e61678214f8d635cc523d787ba4b78530b9251651cf02b19f0e1b7dc4b09e3
...
public class ErrorHandlingTests
{
    ...
    public void Test_ErrorEmptyLanguageName()
    {
        ...
        Assert.ThrowsAny<TreeSitterLanguagePackException>(() => TreeSitterLanguagePackLib.Process("hello", new ProcessConfig { Language = "" }));
    }
    ...
    public void Test_ErrorHandlingEmptySource()
    {
        ...
        var result = TreeSitterLanguagePackLib.Process("", new ProcessConfig { Language = "javascript" });
    }
    ...
    public void Test_ErrorHandlingInvalidSyntax()
    {
        ...
        var result = TreeSitterLanguagePackLib.Process("function function function @@@ %%%", new ProcessConfig { Language = "javascript" });
    }
    ...
    public void Test_ErrorHandlingUnknownLanguage()
    {
        ...
        Assert.ThrowsAny<TreeSitterLanguagePackException>(() => TreeSitterLanguagePackLib.Process("", new ProcessConfig { Language = "nonexistent_xyz" }));
    }
    ...
    public void Test_ErrorProcessEmptySource()
    {
        ...
        var result = TreeSitterLanguagePackLib.Process("", new ProcessConfig { Language = "python" });
    ...
    public void Test_ParseEmptyLanguage()
    {
        ...
        Assert.ThrowsAny<TreeSitterLanguagePackException>(() => TreeSitterLanguagePackLib.Process("x = 1", new ProcessConfig { Language = "" }));
    }
    ...
    public void Test_ProcessUnknownLanguage()
    {
        ...
        Assert.ThrowsAny<TreeSitterLanguagePackException>(() => TreeSitterLanguagePackLib.Process("x = 1", new ProcessConfig { Language = "nonexistent_xyz" }));
    }
}
