...
// alef:hash:2ee9aa4f6e9b5e2708741b916aea83c410337b33396c6fad72092bf803e44f77
...
echo hi`)
	...
	value := *result
	if strings.TrimSpace(value) != `bash` {
...
pass`)
	...
	value := *result
	if strings.TrimSpace(value) != `python` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtCpp(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `cpp` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtJava(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `java` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtJavascript(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `javascript` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtPhp(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `php` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtRuby(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `ruby` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtRust(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `rust` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
...
func Test_DetectExtTypescript(t *testing.T) {
	...
	value := *result
	if strings.TrimSpace(value) != `typescript` {
		t.Errorf("equals mismatch: got %v", value)
	}
}
