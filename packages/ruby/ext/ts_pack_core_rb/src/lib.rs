...
// alef:hash:1ec4c9d499123bf837e2f67ffb7ec2090a7eb94c99c89802508baa2befb0cba7
...
pub struct ExtractionConfig {
    pub language: String,
    pub patterns: HashMap<String, ExtractionPattern>,
}
...
impl ExtractionConfig {
    fn new(language: Option<String>, patterns: Option<HashMap<String, ExtractionPattern>>) -> Self {
        Self {
    ...
    fn patterns(&self) -> HashMap<String, ExtractionPattern> {
        self.patterns.clone()
    }
}
...
pub struct CaptureResult {
    ...
    pub child_fields: HashMap<String, Option<String>>,
...
impl CaptureResult {
    fn new(
        ...
        text: Option<String>,
        child_fields: Option<HashMap<String, Option<String>>>,
    ...
    fn child_fields(&self) -> HashMap<String, Option<String>> {
        self.child_fields.clone()
    }
...
pub struct ExtractionResult {
    pub language: String,
    pub results: HashMap<String, PatternResult>,
}
...
impl ExtractionResult {
    fn new(language: Option<String>, results: Option<HashMap<String, PatternResult>>) -> Self {
        Self {
            language: language.unwrap_or_default(),
    ...
    fn results(&self) -> HashMap<String, PatternResult> {
        self.results.clone()
    }
}
...
pub struct ValidationResult {
    pub valid: bool,
    pub patterns: HashMap<String, PatternValidation>,
}
...
impl ValidationResult {
    fn new(valid: Option<bool>, patterns: Option<HashMap<String, PatternValidation>>) -> Self {
        Self {
            valid: valid.unwrap_or_default(),
            patterns: patterns.unwrap_or_default(),
        }
    ...
    fn patterns(&self) -> HashMap<String, PatternValidation> {
        self.patterns.clone()
    }
}
...
pub struct ProcessResult {
    ...
    pub extractions: HashMap<String, PatternResult>,
}
...
impl ProcessResult {
    fn new(
        ...
        extractions: Option<HashMap<String, PatternResult>>,
    ) -> Self {
        Self {
            language: language.unwrap_or_default(),
    ...
    fn extractions(&self) -> HashMap<String, PatternResult> {
...
pub struct ProcessConfig {
    ...
    pub extractions: Option<HashMap<String, ExtractionPattern>>,
}
...
impl ProcessConfig {
    fn new(
        ...
        extractions: Option<HashMap<String, ExtractionPattern>>,
    ) -> Self {
        Self {
            language: language.unwrap_or_default(),
    ...
    fn extractions(&self) -> Option<HashMap<String, ExtractionPattern>> {
        self.extractions.clone()
    }
...
fn extract_patterns(source: String, config: magnus::Value) -> Result<ExtractionResult, Error> {
...
fn validate_extraction(config: magnus::Value) -> Result<ValidationResult, Error> {
    let config_core: tree_sitter_language_pack::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
impl From<ExtractionPattern> for tree_sitter_language_pack::ExtractionPattern {
    fn from(val: ExtractionPattern) -> Self {
        Self {
            query: val.query,
...
impl From<ExtractionConfig> for tree_sitter_language_pack::ExtractionConfig {
    fn from(val: ExtractionConfig) -> Self {
        Self {
            ...
            patterns: val.patterns.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ExtractionConfig> for ExtractionConfig {
    fn from(val: tree_sitter_language_pack::ExtractionConfig) -> Self {
        Self {
            language: val.language,
            patterns: val.patterns.into_iter().map(|(k, v)| (k, v.into())).collect(),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<CaptureResult> for tree_sitter_language_pack::CaptureResult {
    fn from(val: CaptureResult) -> Self {
        Self {
            name: val.name,
            node: val.node.map(Into::into),
            text: val.text,
            child_fields: val.child_fields.into_iter().collect(),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<MatchResult> for tree_sitter_language_pack::MatchResult {
    fn from(val: MatchResult) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<PatternResult> for tree_sitter_language_pack::PatternResult {
    fn from(val: PatternResult) -> Self {
        Self {
...
impl From<ExtractionResult> for tree_sitter_language_pack::ExtractionResult {
    fn from(val: ExtractionResult) -> Self {
        Self {
            language: val.language,
            results: val.results.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ExtractionResult> for ExtractionResult {
    fn from(val: tree_sitter_language_pack::ExtractionResult) -> Self {
        Self {
            language: val.language,
            results: val.results.into_iter().map(|(k, v)| (k, v.into())).collect(),
        }
    }
}
...
impl From<ProcessResult> for tree_sitter_language_pack::ProcessResult {
    fn from(val: ProcessResult) -> Self {
        Self {
            ...
            extractions: val.extractions.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ProcessResult> for ProcessResult {
    fn from(val: tree_sitter_language_pack::ProcessResult) -> Self {
        Self {
            ...
            diagnostics: val.diagnostics.into_iter().map(Into::into).collect(),
            chunks: val.chunks.into_iter().map(Into::into).collect(),
            extractions: val.extractions.into_iter().map(|(k, v)| (k, v.into())).collect(),
        }
    }
}
