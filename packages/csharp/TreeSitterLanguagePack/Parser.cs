...
// alef:hash:882e9b2c8ed90ca582666cf48144bf27d0d2379ce87d57cdb9ef7f757d105472
#nullable enable
...
/// <summary>/// A tree-sitter parser configured for one language at a time./// /// # Example/// /// ```no_run/// use tree_sitter_language_pack::{get_language, Parser};/// /// let language = get_language("python")?;/// let mut parser = Parser::new();/// parser.set_language(&language)?;/// let tree = parser.parse("def hello(): pass").expect("parse failed");/// assert_eq!(tree.root_node().kind(), "module");/// # Ok::<(), tree_sitter_language_pack::Error>(())/// ```/// </summary>
...
{    private static readonly JsonSerializerOptions JsonOptions = new()
    ...
    public Tree? Parse(string source)
    {
        ...
        var returnValue = JsonSerializer.Deserialize<Tree?>(json ?? "null", JsonOptions)!;
        return returnValue;
    }
