...
// alef:hash:f0d3be738a2b6c919388d5e4a9e6ad26bd56dac788de9cdeb75c08a1cf51df6d
...
pub fn point_from(p: Point) -> Point {
    let p_core: tree_sitter_language_pack::Point = p.into();
    tree_sitter_language_pack::Point::from(p_core).into()
}
...
#[rustler::nif]
pub fn parser_parse(resource: rustler::ResourceArc<Parser>, source: String) -> Option<Tree> {
    None
}
...
/// no language is set.
#[rustler::nif]
pub fn parser_parse_bytes(resource: rustler::ResourceArc<Parser>, source: Vec<u8>) -> Option<Tree> {
    None
}
...
pub fn tree_root_node(resource: rustler::ResourceArc<Tree>) -> ResourceArc<Node> {
    ResourceArc::new(Node {
        inner: Arc::new(resource.inner.root_node()),
    })
}
...
pub fn tree_walk(resource: rustler::ResourceArc<Tree>) -> ResourceArc<TreeCursor> {
    ResourceArc::new(TreeCursor {
        inner: Arc::new(resource.inner.walk()),
    })
}
...
pub fn node_clone(resource: rustler::ResourceArc<Node>) -> ResourceArc<Node> {
    ResourceArc::new(Node {
        inner: Arc::new(resource.inner.clone()),
    })
}
...
#[rustler::nif]
pub fn node_child(resource: rustler::ResourceArc<Node>, index: u32) -> Option<Node> {
    resource
        .inner
        .child(index)
        .map(|v| ResourceArc::new(Node { inner: Arc::new(v) }))
...
pub fn node_child_count(resource: rustler::ResourceArc<Node>) -> usize {
    resource.inner.child_count()
}

/// Return the i-th named child of this node, if any.
#[rustler::nif]
pub fn node_named_child(resource: rustler::ResourceArc<Node>, index: u32) -> Option<Node> {
    resource
        .inner
        .named_child(index)
        .map(|v| ResourceArc::new(Node { inner: Arc::new(v) }))
...
pub fn node_named_child_count(resource: rustler::ResourceArc<Node>) -> usize {
    resource.inner.named_child_count()
}

/// Look up a child by its grammar-defined field name.
#[rustler::nif]
pub fn node_child_by_field_name(resource: rustler::ResourceArc<Node>, name: String) -> Option<Node> {
    resource
        .inner
...
pub fn treecursor_node(resource: rustler::ResourceArc<TreeCursor>) -> ResourceArc<Node> {
    ResourceArc::new(Node {
        inner: Arc::new(resource.inner.node()),
    })
}
...
#[rustler::nif]
pub fn parser_manifest_from_json(json: String) -> Result<ParserManifest, String> {
...
#[rustler::nif]
pub fn platform_bundle_from_json(json: String) -> Result<PlatformBundle, String> {
...
#[rustler::nif]
pub fn language_info_from_json(json: String) -> Result<LanguageInfo, String> {
