...
// alef:hash:f794eaa4a0bf82f98a441962ae9d6f7a572dfb82ebbac859bfdd3e91d7b34e90
...
pub fn downloadmanager_lib_path(resource: rustler::ResourceArc<DownloadManager>, name: String) -> String {
    resource.inner.as_ref().lib_path(&name).to_string_lossy().to_string()
}
...
pub fn downloadmanager_fetch_manifest(
    ...
    let result = resource.inner.as_ref().fetch_manifest().map_err(|e| e.to_string())?;
    Ok(result.into())
}
