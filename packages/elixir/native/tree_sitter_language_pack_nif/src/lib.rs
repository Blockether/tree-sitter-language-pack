...
// alef:hash:6714a5632ba309829de1b751297f4af8d4dc2241c1d84355e99b061c5a703e62
...
#[rustler::nif]
pub fn root_node_info(tree: rustler::ResourceArc<Tree>) -> NodeInfo {
...
#[rustler::nif]
pub fn find_nodes_by_type(tree: rustler::ResourceArc<Tree>, node_type: String) -> Vec<NodeInfo> {
...
#[rustler::nif]
pub fn named_children_info(tree: rustler::ResourceArc<Tree>) -> Vec<NodeInfo> {
...
#[rustler::nif]
pub fn tree_contains_node_type(tree: rustler::ResourceArc<Tree>, node_type: String) -> bool {
...
#[rustler::nif]
pub fn tree_has_error_nodes(tree: rustler::ResourceArc<Tree>) -> bool {
...
#[rustler::nif]
pub fn tree_to_sexp(tree: rustler::ResourceArc<Tree>) -> String {
...
#[rustler::nif]
pub fn tree_error_count(tree: rustler::ResourceArc<Tree>) -> usize {
...
impl From<tree_sitter_language_pack::ProcessConfig> for ProcessConfig {
    fn from(val: tree_sitter_language_pack::ProcessConfig) -> Self {
        Self {
            ...
            diagnostics: val.diagnostics,
            chunk_max_size: val.chunk_max_size,
            extractions: val.extractions.as_ref().map(|m| format!("{m:?}")),
        }
    }
}
...
impl From<tree_sitter_language_pack::download::ParserManifest> for ParserManifest {
    fn from(val: tree_sitter_language_pack::download::ParserManifest) -> Self {
        Self {
            version: val.version,
            platforms: format!("{:?}", val.platforms),
            languages: format!("{:?}", val.languages),
            groups: format!("{:?}", val.groups),
        }
    }
}
