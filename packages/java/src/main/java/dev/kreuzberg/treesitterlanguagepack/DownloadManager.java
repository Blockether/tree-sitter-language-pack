...
// alef:hash:853d26e4ab873c5b0908cd8328d9b0554d679dfd0bfced99a0bd5378908492df
...
public class DownloadManager implements AutoCloseable {
     ...
     *
     * Unlike ensure_languages, this does not check the manifest language list against archive contents — it simply
     * extracts all {@code .so}/{@code .dylib}/{@code .dll} files from the bundle. Languages in the manifest that are
     * missing from the archive are silently ignored rather than returning an error.
     *
