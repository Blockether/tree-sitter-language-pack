...
public class LanguageRegistry implements AutoCloseable {
     ...
     * {@literal @}throws SampleCrateRsException Returns Error.LanguageNotFound if the name (after alias resolution)
    ...
    public boolean hasParser(final String name) throws TreeSitterLanguagePackRsException {
        ...
        try (var arena = Arena.ofShared()) {
            var cName = arena.allocateFrom(name);
            var result = (boolean) NativeLib.TS_PACK_LANGUAGE_REGISTRY_HAS_PARSER.invoke(this.handle, cName);
            return result;
        } catch (Throwable e) {
            if (e instanceof TreeSitterLanguagePackRsException ex) { throw ex; }
    ...
    public static LanguageRegistry defaultInstance() throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofShared()) {
            var handle = (MemorySegment) NativeLib.TS_PACK_LANGUAGE_REGISTRY_DEFAULT.invoke();
