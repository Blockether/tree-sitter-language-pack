...
// alef:hash:48009a1de7f51d1796df793380d70075af272bf6e398396ccaecda04f99e1e17
...
public class LanguageRegistry implements AutoCloseable {
     ...
     *
     * Resolves aliases (e.g., {@code "shell"} -&gt; {@code "bash"}, {@code "makefile"} -&gt; {@code "make"}), then
     * looks up the language in the static table. When the {@code dynamic-loading} feature is enabled, falls back to
     * loading a shared library on demand. {@literal @}throws KreuzbergRsException Returns Error::LanguageNotFound if
     * the name (after alias resolution) does not match any known grammar.
     */
     ...
     *
     * Includes statically compiled languages, dynamically loadable languages (if the {@code dynamic-loading} feature is
     * enabled), and all configured aliases.
     */
     ...
     *
     * Returns {@code true} if the language can be loaded, either from the static table or from a dynamic library on
     * disk.
     */
