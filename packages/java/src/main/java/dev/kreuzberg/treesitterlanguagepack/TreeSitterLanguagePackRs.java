...
// alef:hash:e1d2cbbecb15ad90e2124e5a0e413d2b816ae5636668b259b04fded9a51ca195
...
public final class TreeSitterLanguagePackRs {
    ...
    public static long download(final List<String> names) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var cnamesJson = createObjectMapper().writeValueAsString(names);
    ...
    private static void checkLastError() throws Throwable {
        ...
        if (errCode != 0) {
            ...
            throw new TreeSitterLanguagePackRsException(errCode, msg);
        }
    }
