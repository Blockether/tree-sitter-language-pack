...
public final class TreeSitterLanguagePackRs {
    ...
    private static <T> java.util.List<T> readJsonList(MemorySegment resultPtr, com.fasterxml.jackson.core.type.TypeReference<java.util.List<T>> typeRef) throws TreeSitterLanguagePackRsException {
        if (resultPtr.equals(MemorySegment.NULL)) {
