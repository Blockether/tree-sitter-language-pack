...
public final class TreeSitterLanguagePack {
     ...
     * {@literal @}throws SampleCrateRsException Returns Error.LanguageNotFound if the language is not recognized,
     ...
     * {@literal @}throws SampleCrateRsException Returns Error.LanguageNotFound if the language is not recognized, or
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if the language is not found or parsing fails.
     */
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if configuration cannot be applied or if downloads fail.
     */
     ...
     * languages.
     * {@literal @}throws SampleCrateRsException Returns an error if the lock cannot be acquired.
     */
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if any language is not available in the manifest or if
     * the download fails.
     */
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if the manifest cannot be fetched or the bundle download fails.
     */
     ...
     * Returns the total number of languages now available (statically compiled
     * plus downloaded and cached).
     * {@literal @}throws SampleCrateRsException Returns an error if the manifest cannot be fetched, the group is unknown,
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if the manifest cannot be fetched.
     */
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if the cache directory cannot be removed.
     */
     ...
     * {@literal @}throws SampleCrateRsException Returns an error if the system cache directory cannot be determined.
     */
