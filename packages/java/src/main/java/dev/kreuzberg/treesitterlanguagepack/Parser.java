...
public class Parser implements AutoCloseable {
     ...
     *
     * Resolves the language through the global registry — auto-downloading if necessary, when the {@code download} feature is enabled.
     * {@literal @}throws Exception Returns Error.LanguageNotFound if the language is not recognized, or Error.ParserSetup if the language
     * ABI is incompatible.
     */
