...
// alef:hash:2dee97a617b389a387a5fe40dc309b85168275cdcf8d917689a12cea67f0b6ac
...
public class Parser implements AutoCloseable {
     ...
     *
     * Resolves the language through the global registry — auto-downloading if necessary, when the {@code download}
     * feature is enabled. {@literal @}throws KreuzbergRsException Returns Error::LanguageNotFound if the language is
     * not recognized, or Error::ParserSetup if the language ABI is incompatible.
     */
    ...
    /**
     * Parse a UTF-8 source string. Returns {@code None} if parsing was cancelled or no language is set.
     */
