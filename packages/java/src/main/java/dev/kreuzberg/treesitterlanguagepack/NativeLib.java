...
// alef:hash:8d0489b4a93cca20094f53c4266cc78d95dc0babd5a167f8915b6770c294f07d
...
final class NativeLib {
    ...
    private static void loadNativeLibrary() {
        ...
        try {
            ...
            String msg = "Failed to load ts_pack_core_ffi native library. Expected resource: " + nativesDir + "/"
    ...
    static final MethodHandle TS_PACK_GET_PARSER = LINKER.downcallHandle(LIB.find("ts_pack_get_parser").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_AVAILABLE_LANGUAGES = LINKER.downcallHandle(
            LIB.find("ts_pack_available_languages").orElseThrow(), FunctionDescriptor.of(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_LANGUAGE_COUNT = LINKER.downcallHandle(
            LIB.find("ts_pack_language_count").orElseThrow(), FunctionDescriptor.of(ValueLayout.JAVA_LONG));

    static final MethodHandle TS_PACK_PROCESS = LINKER.downcallHandle(LIB.find("ts_pack_process").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_INIT = LINKER.downcallHandle(LIB.find("ts_pack_init").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_CONFIGURE = LINKER.downcallHandle(LIB.find("ts_pack_configure").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD = LINKER.downcallHandle(LIB.find("ts_pack_download").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD_ALL = LINKER.downcallHandle(
            LIB.find("ts_pack_download_all").orElseThrow(), FunctionDescriptor.of(ValueLayout.JAVA_LONG));

    static final MethodHandle TS_PACK_MANIFEST_LANGUAGES = LINKER.downcallHandle(
            LIB.find("ts_pack_manifest_languages").orElseThrow(), FunctionDescriptor.of(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOADED_LANGUAGES = LINKER.downcallHandle(
            LIB.find("ts_pack_downloaded_languages").orElseThrow(), FunctionDescriptor.of(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_CLEAN_CACHE = LINKER.downcallHandle(LIB.find("ts_pack_clean_cache").orElseThrow(),
            FunctionDescriptor.ofVoid());

    static final MethodHandle TS_PACK_CACHE_DIR = LINKER.downcallHandle(LIB.find("ts_pack_cache_dir").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_FREE_STRING = LINKER.downcallHandle(LIB.find("ts_pack_free_string").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_FREE_BYTES = LINKER.downcallHandle(LIB.find("ts_pack_free_bytes").orElseThrow(),
    ...
    static final MethodHandle TS_PACK_PARSER_PARSE_BYTES = LINKER
            .downcallHandle(LIB.find("ts_pack_parser_parse_bytes").orElseThrow(), FunctionDescriptor
                    .of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG));

    static final MethodHandle TS_PACK_PARSER_RESET = LINKER.downcallHandle(
            LIB.find("ts_pack_parser_reset").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_TREE_ROOT_NODE = LINKER.downcallHandle(
            LIB.find("ts_pack_tree_root_node").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_TREE_WALK = LINKER.downcallHandle(LIB.find("ts_pack_tree_walk").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_NODE_CLONE = LINKER.downcallHandle(LIB.find("ts_pack_node_clone").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_NODE_KIND = LINKER.downcallHandle(LIB.find("ts_pack_node_kind").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_NODE_PARENT = LINKER.downcallHandle(LIB.find("ts_pack_node_parent").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_NODE_CHILD = LINKER.downcallHandle(LIB.find("ts_pack_node_child").orElseThrow(),
    ...
    static final MethodHandle TS_PACK_NODE_WALK = LINKER.downcallHandle(LIB.find("ts_pack_node_walk").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_LANGUAGE_REGISTRY_ADD_EXTRA_LIBS_DIR = LINKER.downcallHandle(
            LIB.find("ts_pack_language_registry_add_extra_libs_dir").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_CACHE_DIR = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_cache_dir").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_ENSURE_LANGUAGES = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_ensure_languages").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_ENSURE_GROUP = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_ensure_group").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_LIB_PATH = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_lib_path").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_FETCH_MANIFEST = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_fetch_manifest").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_LAST_ERROR_CODE = LINKER.downcallHandle(
            LIB.find("ts_pack_last_error_code").orElseThrow(), FunctionDescriptor.of(ValueLayout.JAVA_INT));

    static final MethodHandle TS_PACK_LAST_ERROR_CONTEXT = LINKER.downcallHandle(
            LIB.find("ts_pack_last_error_context").orElseThrow(), FunctionDescriptor.of(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_LANGUAGE_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_language_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_PARSER_TO_JSON = LIB.find("ts_pack_parser_to_json")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle TS_PACK_PARSER_FREE = LINKER.downcallHandle(LIB.find("ts_pack_parser_free").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_PROCESS_RESULT_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_process_result_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_PROCESS_CONFIG_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_process_config_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_PACK_CONFIG_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_pack_config_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    ...
    static final MethodHandle TS_PACK_BYTE_RANGE_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_byte_range_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_POINT_TO_JSON = LIB.find("ts_pack_point_to_json")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle TS_PACK_POINT_FREE = LINKER.downcallHandle(LIB.find("ts_pack_point_free").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_PARSER_MANIFEST_TO_JSON = LIB.find("ts_pack_parser_manifest_to_json")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle TS_PACK_PARSER_MANIFEST_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_parser_manifest_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_TREE_FREE = LINKER.downcallHandle(LIB.find("ts_pack_tree_free").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_NODE_FREE = LINKER.downcallHandle(LIB.find("ts_pack_node_free").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_TREE_CURSOR_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_tree_cursor_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_LANGUAGE_REGISTRY_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_language_registry_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_FREE = LINKER.downcallHandle(
            LIB.find("ts_pack_download_manager_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
