...
final class NativeLib {
    ...
    static final MethodHandle TS_PACK_PARSER_DEFAULT = LINKER.downcallHandle(
        LIB.find("ts_pack_parser_default")
            .or(() -> LIB.find("_ts_pack_parser_default"))  // Try underscore-prefixed variant for macOS
            .orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS)
    );
    ...
    static final MethodHandle TS_PACK_LANGUAGE_REGISTRY_DEFAULT = LINKER.downcallHandle(
        LIB.find("ts_pack_language_registry_default")
            .or(() -> LIB.find("_ts_pack_language_registry_default"))  // Try underscore-prefixed variant for macOS
            .orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS)
    );
    ...
    static final MethodHandle TS_PACK_LANGUAGE_REGISTRY_TO_JSON = LIB.find("ts_pack_language_registry_to_json")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
        .orElse(null);


    static final MethodHandle TS_PACK_DOWNLOAD_MANAGER_TO_JSON = LIB.find("ts_pack_download_manager_to_json")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
        .orElse(null);
