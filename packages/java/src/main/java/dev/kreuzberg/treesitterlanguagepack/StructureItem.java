...
// alef:hash:1260fbc2567a3f4fe560bca1f9687eccc5caa5c416c2f7e75ba1db23f780783b
...
public record StructureItem(StructureKind kind, @Nullable String name, @Nullable String visibility, Span span,
        List<StructureItem> children, List<String> decorators, @Nullable String docComment, @Nullable String signature,
