...
/**
 * Exclusive tree-sitter end positions must not leak into the LINE-BASED edit splice. Grammars whose definition node swallows its
 * terminating newline (Groovy's {@code command}, among others) report the FOLLOWING line as {@code endLine} at column 0; treating that as
 * covered content made {@link StructuralApi.Op#REPLACE} delete whatever definition started there.
 */
