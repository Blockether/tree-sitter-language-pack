...
# alef:hash:0e40e6c87193c910c8c1c2bcd9c244de2d1065bf3d366cdd51c4fc3b4390e5fc
...
StructureKind: TypeAlias = (
    ...
    | StructureKindStructVariant
    | StructureKindInterfaceVariant
    | StructureKindEnumVariant
    | StructureKindModuleVariant
    | StructureKindTraitVariant
    | StructureKindImplVariant
    | StructureKindNamespaceVariant
    | StructureKindOtherVariant
)
...
DocstringFormat: TypeAlias = (
    ...
    | DocstringFormatGoDocVariant
    | DocstringFormatJavaDocVariant
    | DocstringFormatOtherVariant
)
...
SymbolKind: TypeAlias = (
    ...
    | SymbolKindClassVariant
    | SymbolKindTypeVariant
    | SymbolKindInterfaceVariant
    | SymbolKindEnumVariant
    | SymbolKindModuleVariant
    | SymbolKindOtherVariant
)
