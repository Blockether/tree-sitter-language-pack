...
# alef:hash:efec276d0d6fe5fd864aae9dc6b1e25aa52358b4b2319ddcafd25c8b8f102683
...
class ExtractionConfig:
    ...
    patterns: dict[str, ExtractionPattern] = field(default_factory=dict)
...
class CaptureResult:
    ...
    child_fields: dict[str, str | None] = field(default_factory=dict)
...
class ValidationResult(TypedDict, total=False):
    ...
    patterns: dict[str, PatternValidation]
...
class ProcessResult(TypedDict, total=False):
    ...
    extractions: dict[str, PatternResult]
...
class ProcessConfig:
    ...
    extractions: dict[str, ExtractionPattern] | None = None
