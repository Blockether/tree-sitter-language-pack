...
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/.lib/linux-arm64 -Wl,-rpath,${SRCDIR}/.lib/linux-arm64 -lts_pack_core_ffi
...
const (
	...
	// CommentKindBlock CommentKindBlock a block or multi-line comment (e.g., `/* ... */`).
	CommentKindBlock CommentKind = "Block"
	// CommentKindDoc CommentKindDoc a documentation comment (e.g., `/// ...` or `/** ... */`).
...
const (
	...
	// DocstringFormatJsDoc javaScript/TypeScript JSDoc comment (`/** ... */`).
	...
	// DocstringFormatJavaDoc java Javadoc comment (`/** ... */`).
