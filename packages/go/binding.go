...
// alef:hash:034b56a606eee9e06653b424ac1ad97a0d4cbf05c9e8cbf0fc0400e78b5ab10f
// To regenerate: alef generate
// To verify freshness: alef verify --exit-code
// Issues & docs: https://github.com/kreuzberg-dev/alef

// Package tspack provides Go bindings for the liter-llm library.
package tspack
...
func (e *StructureKind) UnmarshalJSON(data []byte) error {
	var value string
	if err := json.Unmarshal(data, &value); err == nil {
		*e = StructureKind(value)
		return nil
	}
...
func (e *DocstringFormat) UnmarshalJSON(data []byte) error {
	var value string
	if err := json.Unmarshal(data, &value); err == nil {
		*e = DocstringFormat(value)
		return nil
	}
	var tagged map[string]string
	if err := json.Unmarshal(data, &tagged); err != nil {
