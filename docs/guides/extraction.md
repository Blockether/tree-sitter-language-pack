...
description: "Custom extraction queries are not part of the v1.6.2 public API."
---

## Extraction queries

Custom query extraction helpers are internal in v1.6.2 and are not exported by the Rust crate or generated language bindings.
