...
| Field       | Type                                      | Default | Description    |
| ----------- | ----------------------------------------- | ------- | -------------- |
| `version`   | `[:0]const u8`                            | —       | Version string |
| `platforms` | `std.StringHashMap(PlatformBundle)`       | —       | Platforms      |
| `languages` | `std.StringHashMap(LanguageInfo)`         | —       | Languages      |
| `groups`    | `std.StringHashMap([]const [:0]const u8)` | —       | Groups         |
