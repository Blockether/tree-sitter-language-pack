...
// alef:hash:24fa42221ee6383da313df8240b78ef9ab763067f97a2f553cd5c256766e2a83
...
"#;
    ...
    assert_eq!(result.language.trim(), r#"c"#, "equals assertion failed");
...
"#;
    ...
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"go"#, "equals assertion failed");
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
        format!("{:?}", result.structure).contains(r#"Function"#),
        "expected to contain: {}",
...
"#;
    ...
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"java"#, "equals assertion failed");
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
...
"#;
    ...
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"kotlin"#, "equals assertion failed");
    assert!(
        result.structure.len() >= 2,
        "expected at least 2 elements, got {}",
        result.structure.len()
...
def third():
    ...
    return z
"#;
    let config_json = serde_json::json!({"chunk_max_size": 50, "language": "python"});
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"python"#, "equals assertion failed");
    assert!(
    ...
    assert!(result.chunks[0].content.len() <= 50, "expected <= 50");
}
...
def delta():
    pass
"#;
    let config_json = serde_json::json!({"chunk_max_size": 30, "language": "python"});
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"python"#, "equals assertion failed");
    ...
    assert!(result.chunks[0].content.len() <= 30, "expected <= 30");
}
...
fn test_python_error_diagnostics() {
    ...
    pass
"#;
    let config_json = serde_json::json!({"diagnostics": true, "language": "python"});
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"python"#, "equals assertion failed");
...
"#;
    ...
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"ruby"#, "equals assertion failed");
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
        format!("{:?}", result.structure).contains(r#"Class"#),
        "expected to contain: {}",
...
fn delta() {}
"#;
    let config_json = serde_json::json!({"chunk_max_size": 30, "language": "rust"});
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
...
"#;
    ...
    let config = serde_json::from_value(config_json).unwrap();
    let result = process(source, &config).expect("should succeed");
    assert_eq!(result.language.trim(), r#"typescript"#, "equals assertion failed");
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
        format!("{:?}", result.structure).contains(r#"Function"#),
        "expected to contain: {}",
