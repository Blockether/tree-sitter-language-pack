...
root_url="https://github.com/kreuzberg-dev/tree-sitter-language-pack/releases/download/${tag}"
...
cli_block="$(render_bottle_block ts-pack)"
ffi_block="$(render_bottle_block libts-pack)"
