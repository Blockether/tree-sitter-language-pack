...
// alef:hash:dfd77225966e4b712149264465a98e0e13491ead15762b66d81a887d3c478742
...
impl ProcessConfig {
    #[php(name = "from_json")]
    pub fn from_json(json: String) -> PhpResult<Self> {
        // Deserialize via a helper that uses the same defaults as core ProcessConfig
        // (structure/imports/exports default to true) while allowing language to be absent.
        #[derive(serde::Deserialize)]
        struct Helper {
            #[serde(default)]
            language: String,
            #[serde(default = "helper_true")]
            structure: bool,
            #[serde(default = "helper_true")]
            imports: bool,
            #[serde(default = "helper_true")]
        ...
        fn helper_true() -> bool { true }
        let h: Helper = serde_json::from_str(&json).map_err(|e| PhpException::default(e.to_string()))?;
        Ok(Self {
            language: h.language,
            ...
            exports: h.exports,
            comments: h.comments,
            docstrings: h.docstrings,
            symbols: h.symbols,
            diagnostics: h.diagnostics,
            chunk_max_size: h.chunk_max_size,
        })
    }
    ...
    fn from(val: StructureItem) -> Self {
        Self {
            kind: match val.kind.as_str() {
                ...
                _ => tree_sitter_language_pack::StructureKind::Function,
            },
            name: val.name,
    ...
    fn from(val: CommentInfo) -> Self {
        Self {
            ...
            kind: match val.kind.as_str() {
                ...
                _ => tree_sitter_language_pack::CommentKind::Line,
            },
            span: val.span.into(),
    ...
    fn from(val: DocstringInfo) -> Self {
        Self {
            ...
            format: match val.format.as_str() {
                ...
                _ => tree_sitter_language_pack::DocstringFormat::PythonTripleQuote,
            },
            span: val.span.into(),
    ...
    fn from(val: ExportInfo) -> Self {
        Self {
            ...
            kind: match val.kind.as_str() {
                ...
                _ => tree_sitter_language_pack::ExportKind::Named,
            },
            span: val.span.into(),
        }
    }
    ...
    fn from(val: SymbolInfo) -> Self {
        Self {
            ...
            kind: match val.kind.as_str() {
                ...
                _ => tree_sitter_language_pack::SymbolKind::Variable,
            },
            span: val.span.into(),
    ...
    fn from(val: Diagnostic) -> Self {
        Self {
            ...
            severity: match val.severity.as_str() {
                ...
                _ => tree_sitter_language_pack::DiagnosticSeverity::Error,
            },
            span: val.span.into(),
        }
    }
