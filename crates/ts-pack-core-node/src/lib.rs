...
// alef:hash:f8b121239cf9e0e2d737df888e218d37d811dbeff438a3e0dd9d5d0b65487862
...
pub struct JsExtractionConfig {
    ...
    pub patterns: Option<HashMap<String, JsExtractionPattern>>,
}
...
pub struct JsCaptureResult {
    ...
    #[napi(js_name = "childFields")]
    pub child_fields: Option<HashMap<String, Option<String>>>,
...
pub struct JsExtractionResult {
    pub language: Option<String>,
    pub results: Option<HashMap<String, JsPatternResult>>,
}
...
pub struct JsValidationResult {
    pub valid: Option<bool>,
    pub patterns: Option<HashMap<String, JsPatternValidation>>,
}
...
pub struct JsProcessResult {
    ...
    pub extractions: Option<HashMap<String, JsPatternResult>>,
}
...
pub struct JsProcessConfig {
    ...
    pub extractions: Option<HashMap<String, JsExtractionPattern>>,
}
...
impl From<JsExtractionPattern> for tree_sitter_language_pack::ExtractionPattern {
    fn from(val: JsExtractionPattern) -> Self {
        Self {
            query: val.query.unwrap_or_default(),
            capture_output: val.capture_output.map(Into::into).unwrap_or_default(),
            child_fields: val.child_fields.unwrap_or_default(),
            max_results: val.max_results.map(|v| v as usize),
...
impl From<tree_sitter_language_pack::ExtractionConfig> for JsExtractionConfig {
    fn from(val: tree_sitter_language_pack::ExtractionConfig) -> Self {
        Self {
            ...
            patterns: Some(val.patterns.into_iter().map(|(k, v)| (k, v.into())).collect()),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCaptureResult> for tree_sitter_language_pack::CaptureResult {
    fn from(val: JsCaptureResult) -> Self {
        Self {
            name: val.name.unwrap_or_default(),
            node: val.node.map(Into::into),
            text: val.text,
            child_fields: val.child_fields.unwrap_or_default().into_iter().collect(),
...
impl From<tree_sitter_language_pack::CaptureResult> for JsCaptureResult {
    fn from(val: tree_sitter_language_pack::CaptureResult) -> Self {
        Self {
            ...
            node: val.node.map(Into::into),
            text: val.text,
            child_fields: Some(val.child_fields.into_iter().collect()),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsMatchResult> for tree_sitter_language_pack::MatchResult {
    fn from(val: JsMatchResult) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPatternResult> for tree_sitter_language_pack::PatternResult {
    fn from(val: JsPatternResult) -> Self {
        Self {
            matches: val
                .matches
                .map(|v| v.into_iter().map(Into::into).collect())
                .unwrap_or_default(),
            total_count: val.total_count.map(|v| v as usize).unwrap_or_default(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ExtractionResult> for JsExtractionResult {
    fn from(val: tree_sitter_language_pack::ExtractionResult) -> Self {
        Self {
            language: Some(val.language),
            results: Some(val.results.into_iter().map(|(k, v)| (k, v.into())).collect()),
        }
    }
}
...
impl From<JsPatternValidation> for tree_sitter_language_pack::PatternValidation {
    fn from(val: JsPatternValidation) -> Self {
        Self {
            ...
            capture_names: val.capture_names.unwrap_or_default(),
            pattern_count: val.pattern_count.map(|v| v as usize).unwrap_or_default(),
            warnings: val.warnings.unwrap_or_default(),
            errors: val.errors.unwrap_or_default(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ProcessResult> for JsProcessResult {
    fn from(val: tree_sitter_language_pack::ProcessResult) -> Self {
        Self {
            ...
            extractions: Some(val.extractions.into_iter().map(|(k, v)| (k, v.into())).collect()),
        }
    }
}
