...
// alef:hash:238564c185860e68890cb9b6c7bf676be9ee3ef4dd85b901e308b4138de2f55a
...
impl JsLanguageRegistry {
    ...
    pub fn get_language(&self, env: &napi::Env, name: String) -> napi::Result<napi::bindgen_prelude::Object<'_>> {
        let value = self
            .inner
            .get_language(&name)
