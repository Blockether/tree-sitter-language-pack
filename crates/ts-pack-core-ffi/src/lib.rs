...
// alef:hash:5520b1afd4a88c4628dcbfcb5a3ae2ee435e712db8a2a6da4c397dbecef84988
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_detect_language_from_extension_len(ext: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if ext.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'ext'");
        return 0;
    ...
    result.as_deref().map_or(0, |s| s.len())
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_detect_language_from_path_len(path: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if path.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'path'");
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_detect_language_from_content_len(content: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if content.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'content'");
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_get_highlights_query_len(language: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if language.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'language'");
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_get_injections_query_len(language: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if language.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'language'");
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_get_locals_query_len(language: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if language.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'language'");
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_detect_language_len(path: *const std::ffi::c_char) -> usize {
    clear_last_error();
    if path.is_null() {
        set_last_error(1, "Null pointer passed for parameter 'path'");
        return 0;
