...
// alef:hash:ee81d51f1645976d9cb605f2f298b6fd77e00b12a3a3c51eec6fa59543cc2ad3
...
impl WasmParser {
    ...
    pub fn set_language(&self, _name: String) -> Result<(), JsValue> {
        Err(JsValue::from_str("Not implemented: set_language"))
    }

    /// Parse a UTF-8 source string. Returns `None` if parsing was cancelled
    /// or no language is set.
    #[wasm_bindgen]
    pub fn parse(&self, _source: String) -> Option<WasmTree> {
        None
    }
    ...
    pub fn parse_bytes(&self, _source: Vec<u8>) -> Option<WasmTree> {
        None
    }
...
pub struct WasmTreeCursor {
    pub(crate) inner: Arc<tree_sitter_language_pack::TreeCursor>,
}
