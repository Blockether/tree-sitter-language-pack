...
// alef:hash:f713482baedf86efa22c859a3add67e12e463597832bd2c0e16a3ced421461c0
...
impl ExtractionConfig {
    ...
    #[new]
    pub fn new(language: Option<String>, patterns: Option<HashMap<String, ExtractionPattern>>) -> Self {
        Self {
...
impl ExtractionResult {
    ...
    #[new]
    pub fn new(language: Option<String>, results: Option<HashMap<String, PatternResult>>) -> Self {
        Self {
            language: language.unwrap_or_default(),
...
impl ValidationResult {
    ...
    #[new]
    pub fn new(valid: Option<bool>, patterns: Option<HashMap<String, PatternValidation>>) -> Self {
        Self {
            valid: valid.unwrap_or_default(),
            patterns: patterns.unwrap_or_default(),
        }
